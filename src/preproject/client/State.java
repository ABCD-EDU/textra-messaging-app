...
public class State {
    // success states
    public final static String SUCCESS_LOGIN_USER = "SUCCESS_LOGIN_USER";
    public final static String SUCCESS_LOGOUT_USER = "SUCCESS_LOGOUT_USER";
    public final static String SUCCESS_REGISTER_USER = "SUCCESS_REGISTER_USER";
    public final static String SUCCESS_SEND_MESSAGE = "SUCCESS_SEND_MESSAGE";
    ...
    public final static String FAIL_LOGOUT_USER = "FAIL_LOGOUT_USER";
    public final static String FAIL_REGISTER_USER = "FAIL_REGISTER_USER";
    public final static String FAIL_SEND_MESSAGE = "FAIL_SEND_MESSAGE";
