...
public class AdminController implements Initializable {
    ...
    public void initializeAcceptDeclineAllButton() {
        acceptAllButton.setOnAction(e -> {
            ...
            try {
                ...
                boolean successPost = (boolean) Main.serverConnector.getObjIn().readObject();
                if (successPost) {
    ...
    public void verifyRegistration(String email, boolean isVerified) {
        try {
            ...
            Map<String, Boolean> response = (Map<String, Boolean>) Main.serverConnector.getObjIn().readObject();
    ...
    private List<Map<String, String>> getRegisteredUsers(Map<String, String> request) throws IOException, ClassNotFoundException {
        Main.serverConnector.getObjOut().writeObject(request);
        return (List<Map<String, String>>) Main.serverConnector.getObjIn().readObject();
    }
}